...
public class Cluedo {
	...
	public static String checkForHelp() {
			return  "Every character, weapon and room is represented by a card in the game. Before the game starts, one\n" + 
					...
					"which comprises the room they are in, a character and a weapon. This is done by selecting your choices on pop-up windows.\n" + 
					...
					"one the player making the accusation may be in). It is selected in the exact same way as a suggestion.\n" + 
